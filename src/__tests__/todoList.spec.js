...
beforeEach(() => {
  todoItem1 = new TodoItem(1, '할 일 1', new Date(), false);
  todoItem2 = new TodoItem(2, '할 일 2', new Date(), false);
  todoItem3 = new TodoItem(3, '할 일 3', new Date(), false);
  todoItem4 = new TodoItem(4, '할 일 4', new Date(), false);
  todoItem5 = new TodoItem(5, '할 일 5', new Date(), false);
...
describe("생성한 할 일들 중에서 오늘 할 일, 지난 할 일 구분하기.", () => {
  test("5개의 할 일이 있는데, 모두 오늘 만들 일이다.", () => {
    jest.spyOn(todoItem2, "equalsDayOfCreateAt").mockImplementation(() => false);
